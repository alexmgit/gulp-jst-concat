...
module.exports = function jstConcat(fileName, _opts) {
  ...
  function end () {
    /* jshint validthis: true */
    var jstString = buildJSTString(files, opts.renameKeys, opts.JSTStringTemplate)
